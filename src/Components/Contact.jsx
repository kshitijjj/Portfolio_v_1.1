        ...
        <div className="md:mt-[7rem] flex flex-col-reverse md:flex-row md:justify-between mt-[4.5rem] ">
            ...
            <form className='pl-[1.5rem] md:pl-[5rem] pt-[3.2rem] pb-[2rem]'>
                <div className='pb-7 gap-1 flex flex-col'>
                    ...
                    <input className='md:bg-[#EAE7E7] w-[20rem] md:w-[32rem] md:bg-opacity-35 p-[0.4rem] py-2  md:pr-12 md:pl-4 md:py-3 rounded-lg border-2 border-blue-100' type="text" name="Enter your name" placeholder='Enter your name' id=""  />
                </div>
 
                <div className='pb-7 gap-1 flex flex-col'>
                    <p className='font-montserrat font-bold text-[0.8rem] md:text-[1rem] text-opacity-85'>Email</p>
                    <input className='md:bg-[#EAE7E7] w-[20rem] md:w-[32rem] md:bg-opacity-35 p-[0.4rem]  py-2  md:pr-12 md:pl-4 md:py-3 rounded-lg border-2 border-blue-100' type="email" name="Enter your email" placeholder='Enter your mail' id="" />
                </div>

                <div className='gap-1 flex flex-col '>
                    <p className='font-montserrat font-bold text-[0.8rem] md:text-[1rem] text-opacity-85'>Message</p>
                    <input className='md:bg-[#EAE7E7] w-[20rem] md:w-[32rem] md:bg-opacity-35 p-[0.4rem]  py-2  md:pr-12 md:pl-4 md:py-3 rounded-lg border-2 border-blue-100' type="text" name="Enter your message" placeholder='Enter your message' id="" />
                </div>
