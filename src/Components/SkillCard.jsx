...
const SkillCard = (props) => {
    return (
        <div className='bg-[#EAE7E7] bg-opacity-35 w-[20rem] p-2 mb-[0.9rem] md:p-6 flex md:mb-[2rem] md:w-[35rem] rounded-md justify-between border-2 text-center items-center'  >
