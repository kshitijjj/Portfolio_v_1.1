...
const ProjectCard = (props) => {
    return (
        <div className='bg-[#EAE7E7] bg-opacity-35 md:p-6 p-8 w-[45rem] rounded-[1rem] md:ml-[4rem] border-2 mb-[5rem]'> 
            
            {/* Inner object div */}
            <div className='flex flex-col md:flex-row justify-center items-center'>

                {/* Image */}
                <div className='bg-white rounded-[1.6rem] justify-center items-center w-[18rem] md:w-[25rem]'>
                    <img className='w-full rounded-[0.8rem] border-2 border-white' src={props.mainimg} alt="" srcset="" />
                </div>

                {/* Text */}
                <div className='pt-2 pl-1 text-center  md:p-6 md:text-left md:pl-[2.5rem] md:w-[35rem] w-[25rem]'>
